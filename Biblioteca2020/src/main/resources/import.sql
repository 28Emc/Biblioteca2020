...
INSERT INTO empleados (apellidos, celular, direccion, email, estado, foto_empleado, fecha_registro, nombres, nro_documento, password, username, local_id) VALUES ('Apellido Admin', 98989898, 'No disponible', 'admin@gmail.com', 1, 'tilin.jpg', '2019-08-19', 'Nombre Admin', 11111111, '$2a$10$DCDKy8zxMgnhv7BoTopltOq2qlT1icvmk/JMzT51BWmdWcKGOFFjS', 'admin', 1);
INSERT INTO empleados (apellidos, celular, direccion, email, estado, foto_empleado, fecha_registro, nombres, nro_documento, password, username, local_id) VALUES ('Apellido Empleado', 87878787, 'Av. El Sol 130', 'empleado@gmail.com', 1, 'no-image.jpg', '2019-08-19', 'nombreEmpleado', 22222222, '$2a$10$7JtXWUaIkParaGFFYZI5xeZgf4lA365rrG0Hgi3.4qymiQfy.B85O', 'empleado', 1);
INSERT INTO empleados (apellidos, celular, direccion, email, estado, foto_empleado, fecha_registro, nombres, nro_documento, password, username, local_id) VALUES ('Apellido Empleada', 76767676, 'Av. Los Duraznos 653', 'empleada@gmail.com', 1, 'no-image.jpg', '2019-08-19', 'nombreEmpleada', 33333333, '$2a$10$rE9nFn/v1kcabjkQW/QABeuKGHirYoLWjcG.WHDVSfth7bhZM7JWi', 'empleada', 2);
/* EMPLEADOS-ROLES */
INSERT INTO empleados_roles (empleado_id, rol_id) VALUES (2,2);
INSERT INTO empleados_roles (empleado_id, rol_id) VALUES (3,4);
INSERT INTO empleados_roles (empleado_id, rol_id) VALUES (4,4);
/* LIBROS */
