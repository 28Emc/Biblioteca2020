...
/* EMPLEADOS */
INSERT INTO empleados (apellidos, celular, direccion, email, estado, fecha_registro, nombres, nro_documento, password, username, local_id) VALUES ('Prueba', 000000000, 'Prueba', 'prueba@gmail.com', 1, '2020-04-08', 'Prueba', 00000000, 'Prueba', 'Prueba', 1);
...
INSERT INTO empleados (apellidos, celular, direccion, email, estado, fecha_registro, nombres, nro_documento, password, username, local_id) VALUES ('Apellido Empleado', 87878787, 'Av. El Sol 130', 'empleado@gmail.com', 1, '2019-08-19', 'nombreEmpleado', 22222222, '$2a$10$7JtXWUaIkParaGFFYZI5xeZgf4lA365rrG0Hgi3.4qymiQfy.B85O', 'empleado', 1);
